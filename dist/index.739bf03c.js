...
var _linesController = require("./linesController");
...
const tooltip = new (0, _tooltip.Tooltip)(document.querySelector("aside.tooltip"));
// 4 lines that move around
const lineController = new (0, _linesController.LinesController)([
...
const zoomIn = ()=>{
    ...
    isAnimating = true;
    const flipstateNav = (0, _flip.Flip).getState(navImages, {
        simple: true
    });
    const flipstateGallery = (0, _flip.Flip).getState(tooltip.DOM.images[tooltip.current], {
        simple: true
    });
    ...
    const linePos = {
        ...
        horizontal: [
            imageRect.top,
            -winsize.height + (imageRect.top + tooltip.DOM.images[tooltip.current].offsetHeight)
        ],
        // first and second vertical lines x translations
        vertical: [
            imageRect.left,
            -winsize.width + (imageRect.left + tooltip.DOM.images[tooltip.current].offsetWidth)
        ]
    };
    zoomintl = (0, _gsap.gsap).timeline({
        defaults: {
            duration: 0.7,
            ease: "power4"
        },
        ...
        (0, _flip.Flip).from(flipstateNav, flipOpts);
        (0, _flip.Flip).from(flipstateGallery, flipOpts);
    }, "start").to(lineController.DOM.linesHorizontal[0], {
        y: linePos.horizontal[0],
        opacity: 1
    }, "start").to(lineController.DOM.linesHorizontal[1], {
        y: linePos.horizontal[1],
        opacity: 1
    }, "start").to(lineController.DOM.linesVertical[0], {
        x: linePos.vertical[0],
        opacity: 1
    }, "start").to(lineController.DOM.linesVertical[1], {
...
const zoomOut = ()=>{
    ...
    const linePos = {
        ...
        horizontal: [
            galleryRect.top,
            -winsize.height + (galleryRect.top + gallery.offsetHeight)
        ],
        // first and second vertical lines x translations
        vertical: [
            galleryRect.left,
            -winsize.width + (galleryRect.left + gallery.offsetWidth)
        ]
    };
    zoomouttl = (0, _gsap.gsap).timeline({
        defaults: {
            duration: 0.7,
            ease: "power4"
        },
...
link.addEventListener("mouseenter", ()=>{
    ...
    const linePos = {
        ...
        horizontal: [
            tooltip.rect.top,
            -winsize.height + (tooltip.rect.top + tooltip.DOM.images[tooltip.current].offsetHeight)
        ],
        // first and second vertical lines x translations
        vertical: [
            tooltip.rect.left,
            -winsize.width + (tooltip.rect.left + tooltip.DOM.images[tooltip.current].offsetWidth)
        ]
    };
    entertl = (0, _gsap.gsap).timeline({
        defaults: {
            duration: 1,
            ease: "power4.inOut"
        }
    }).addLabel("start", 0).to(lineController.DOM.linesHorizontal[0], {
        startAt: {
...
link.addEventListener("mouseleave", ()=>{
    ...
    }).addLabel("start", 0).to(tooltip.DOM.el, {
        duration: 0.6,
        opacity: 0
    }, "start").to(lineController.DOM.lines, {
        x: 0,
        y: 0,
        opacity: 0
    }, "start");
...
link.addEventListener("click", ()=>{
    ...
    clicktl = (0, _gsap.gsap).timeline({
        ...
        const flipstate = (0, _flip.Flip).getState(tooltip.DOM.images[tooltip.current], {
            simple: true
        });
        ...
        (0, _flip.Flip).from(flipstate, flipOpts);
        ...
        xPercent: 0,
        stagger: 0.06
    }, "start").to(galleryTitle, {
        y: 0
    }, "start").to(pretitle.back, {
        y: 0
    }, "start").to(pretitle.title, {
        y: "-100%"
    }, "start");
});
// back to main page
pretitle.back.addEventListener("click", ()=>{
    ...
    backtl = (0, _gsap.gsap).timeline({
    ...
    }).addLabel("start", 0).to(navImages, {
        duration: 0.5,
        opacity: 0,
        xPercent: 150,
        onComplete: ()=>content.classList.remove("content--open")
    }, "start+=0.15").to(pretitle.back, {
        y: "100%"
    }, "start").to(pretitle.title, {
        y: 0
    }, "start").to(galleryTitle, {
        ...
        x: linePos.vertical[1]
    }, "start").to(tooltip.DOM.images[tooltip.current], {
        duration: 0.85,
        //ease: 'expo',
        scale: 0,
        opacity: 0,
        onComplete: ()=>{
            ...
            (0, _gsap.gsap).set(tooltip.DOM.images[tooltip.current], {
                scale: 1,
                opacity: 1
            });
        }
...
window.addEventListener("resize", ()=>{
    ...
    (0, _gsap.gsap).set(lineController.DOM.linesHorizontal[0], {
        y: linePos.horizontal[0]
    });
    (0, _gsap.gsap).set(lineController.DOM.linesHorizontal[1], {
        y: linePos.horizontal[1]
    });
    (0, _gsap.gsap).set(lineController.DOM.linesVertical[0], {
        x: linePos.vertical[0]
    });
    (0, _gsap.gsap).set(lineController.DOM.linesVertical[1], {
        x: linePos.vertical[1]
    });
});
// Preload images
(0, _utils.preloadImages)(".tooltip__img-inner, nav__img-inner").then(()=>document.body.classList.remove("loading"));

},{"./utils":"72Dku","./tooltip":"7F96J","./linesController":"478OC","gsap":"fPSuC","gsap/Flip":"iKp6p"}],"72Dku":[function(require,module,exports) {
...
},{}],"7F96J":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
/**
...
class Tooltip {
	 ...
	 */ constructor(DOM_el){
        ...
        this.DOM.images = [
            ...this.DOM.el.querySelectorAll(".tooltip__img")
        ];
     ...
     */ showNextImage() {
        this.slideshow = (0, _gsap.gsap).delayedCall(this.slideshowInterval, ()=>{
            // update current
     ...
     */ stopSlideshow() {
        if (this.slideshow) this.slideshow.kill();
    }
    /**
...
},{"./gsap-core.js":"05eeC","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"478OC":[function(require,module,exports) {
/**
 * Class representing the 4 lines that move along with the images
 */ var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "LinesController", ()=>LinesController);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["cVgJb","ebWYT"], "ebWYT", "parcelRequire1d54")
